...
class TableCrafter {
    ...
    public function enqueue_admin_assets($hook) {
        ...
        if (strpos($hook, 'tablecrafter') === false) {
            return;
        }
        ...
        wp_localize_script('tablecrafter-admin', 'tablecrafterAdmin', array(
            'i18n' => array(
                'enterUrl'   => __('Please enter a valid URL', 'tablecrafter'),
                'loading'    => __('Loading data from source...', 'tablecrafter'),
                'libMissing' => __('TableCrafter library not loaded.', 'tablecrafter'),
                'copyFailed' => __('Failed to copy to clipboard. Please copy manually.', 'tablecrafter'),
                'copied'     => __('Copied to Clipboard!', 'tablecrafter')
            )
        ));
