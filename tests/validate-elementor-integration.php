...
if (!class_exists('\Elementor\Widget_Base')) {
    ...
    // Define Mock Classes
    class MockElementor_Controls_Manager
    {
    ...
    class MockElementor_Group_Control_Typography
    {
    ...
    class MockElementor_Scheme_Typography
    {
    }
    class MockElementor_Scheme_Color
    {
    }

    class MockElementor_Group_Control_Border
    {
        public static function get_type()
        {
            return 'border';
    ...
    class MockElementor_Group_Control_Box_Shadow
    {
        public static function get_type()
        {
            return 'box-shadow';
    ...
    class MockElementor_Widgets_Manager
    {
    ...
    class MockElementor_Plugin
    {
        ...
        {
            $this->editor = new MockElementor_Editor();
            $this->widgets_manager = new MockElementor_Widgets_Manager();
        }
    ...
    // Register Aliases
    class_alias('MockElementorWidget', 'Elementor\Widget_Base');
    class_alias('MockElementor_Controls_Manager', 'Elementor\Controls_Manager');
    class_alias('MockElementor_Group_Control_Typography', 'Elementor\Group_Control_Typography');
    class_alias('MockElementor_Scheme_Typography', 'Elementor\Scheme_Typography');
    class_alias('MockElementor_Scheme_Color', 'Elementor\Scheme_Color');
    class_alias('MockElementor_Group_Control_Border', 'Elementor\Group_Control_Border');
    class_alias('MockElementor_Group_Control_Box_Shadow', 'Elementor\Group_Control_Box_Shadow');
    class_alias('MockElementor_Plugin', 'Elementor\Plugin');
}
...
class ElementorWidgetValidator
{
    ...
    private function test_performance()
    {
        ...
        $complex_settings = [
            ...
            'include_columns' => implode(',', array_map(function ($i) {
                return 'col_' . $i; }, range(1, 100))),
            'enable_search' => 'yes',
            'enable_filters' => 'yes',
            'enable_export' => 'yes',
            'per_page' => 1000,
